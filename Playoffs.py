...
# List from my solver
BG = ["BG",0.28672133,top2,9900]
CHA = ["CHA",0.21721313,top2,9700]
BT = ["BT",0.18618268,top2,9500]
KCT = ["KCT",0.10698557,top2,8200]
BSC = ["BSC",0.07097063,top2,6800]
TDP = ["TDP",0.05251306,top2,5700]
EJ = ["EJ",0.04072746,top2,4800]
AA = ["AA",0.02493229,top2,3300]
DDB = ["DDB",0.00725509,top2,1100]
THR = ["THR",0.00587303,top2,900]
MTA = ["MTA",0.00062573,top2,100]
NSR = ["NSR",0.0000,top2,0]
